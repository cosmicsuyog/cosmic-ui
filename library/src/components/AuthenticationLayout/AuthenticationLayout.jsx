...
const LoginForm = ({
  onSubmit = () => {}
}) => <FormWrapper title="Login" onSubmit={onSubmit}><Input label="Email" type="email" /><Input label="Password" type="password" /></FormWrapper>;
export const AuthenticationLayout = ({
  children,
  title = "Welcome back"
}) => <Center minHeight="100vh"><Stack align="center"><h1>{title}</h1>{children || <LoginForm />}</Stack></Center>;
